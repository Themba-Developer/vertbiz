...
export const Route = createFileRoute("/summary")({
  head: () => ({
    meta: [
      { title: "Review Your Application — RegistrCo" },
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Check everything carefully — these details will be submitted to CIPC.
            </p>
          </div>
          <Link
            to="/register"
        ...
        <div className="grid gap-6">
          ...
          <div className="rounded-xl border border-border bg-card p-5">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-foreground">
                I understand that proposed company names are subject to CIPC
                availability and approval, and that processing typically takes{" "}
                <strong>2–3 business days</strong>. I accept the terms and
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-between">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-md bg-accent text-accent-foreground px-6 py-3 text-sm font-semibold hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
